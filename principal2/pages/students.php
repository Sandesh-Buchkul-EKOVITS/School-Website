...
if(isset($_POST['save_student'])){
    ...
    if($id == ""){
        $stmt = $conn->prepare("INSERT INTO students (name, roll_no, `class`, gender, phone)
                                VALUES (?,?,?,?,?)");
        $stmt->bind_param("sssss",$name,$roll,$class,$gender,$phone);
    }else{
        $stmt = $conn->prepare("UPDATE students SET
                                ...
                                phone=?
                                WHERE id=?");
        $stmt->bind_param("sssssi",$name,$roll,$class,$gender,$phone,$id);
    }
